...
const Sidebar = () => {
  ...
  return (
    <div className="w-64 bg-gradient-to-b from-purple-600 to-purple-500 dark:from-gray-900 dark:to-gray-800 shadow-lg h-screen p-6 hidden md:flex flex-col">
      {/* <h2 className="text-3xl font-extrabold text-white dark:text-gray-100 mb-8 tracking-wide">Student ERP</h2> */}
      <div className="pb-4">
        <img src="https://i.postimg.cc/TwThxvvR/ai-risezonic-white-Photoroom.png" alt="" />
      </div>
            ...
            <Link
              ...
              className={`flex items-center px-4 py-3 rounded-lg transition-colors duration-200 ${
                location.pathname === item.to
                  ? "bg-white text-gray-600 font-semibold shadow dark:bg-gray-900 dark:text-white"
                  : "text-white hover:bg-gray-800 hover:text-white dark:text-gray-200 dark:hover:bg-gray-700"
              }`}
            >
